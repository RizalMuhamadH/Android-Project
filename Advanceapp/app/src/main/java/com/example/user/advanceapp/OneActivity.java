...
//    Cursor exp,inc;
//
//    ListView listexp,listinc;
//
//    CardView cv_exp,cv_inc;
...
//        myDB = new DatabaseHelper(OneActivity.this);
//        exp = myDB.list_expanses();
//        inc = myDB.list_income();
//
//        listexp = (ListView)findViewById(R.id.listViewExp);
//        listinc = (ListView) findViewById(R.id.listViewInc);
//        cv_exp = (CardView) findViewById(R.id.cv_expenses);
//        cv_inc = (CardView) findViewById(R.id.cv_income);
